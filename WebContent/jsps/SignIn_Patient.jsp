...
<div align="center" style="margin-top: 200px;">
	<h3 align="center">Patient's Login</h3>

	<html:form action="/loginPatient" styleId="loginForm">
		<table>
		<html:errors property="login.invalid" />
			<tr align="center">
				<td>
				<html:text property="loginID" styleId="logID" title="Enter Name"/>
				</td>
			</tr>
			<tr align="center">
				<td>
			...
			<tr align="center">
				<td align="center" ><a href="./HTML/SignUpPatient.html">Sign-Up</a></td>
			</tr>
		</table>
	</html:form>
